            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="table-responsive">
                        <form class="form-group" action="{{route('admin.posts.store')}}"
                              method="post">
                            @csrf
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <label for="inputID"
                                                   class="control-label">Tiêu đề bài viết:</label>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <label for="inputID"
                                                   class="control-label">Ngày đăng:</label>
                                            <input type="text" name="date" class="form-control"
                                                   required="required"
                                                   value="{{\Carbon\Carbon::now('Asia/Ho_Chi_Minh')->toDayDateTimeString()}}">
                                        </div>
                                    </td>
                                </tr>
                                </tbody>
                            ...
                            <table class="table table-hover">
                                ...
                                <tr>
                                    <td>
                                        <label for="inputID"
                                               class="control-label">Nội dung:</label>
