        ...
        <header id="fh5co-header-section" class="sticky-banner">
            <div class="container">
                <div class="nav-header">
                    ...
                    <h1 id="fh5co-logo"><a href="{{ url('/home') }}"><i class="icon-home"></i>Home<span>state</span></a></h1>
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <table class="table table-striped table-hover">
                        <tbody>
                        <form class="form-group" action="{{route('admin.products.update', $products->id)}}" method="post" enctype="multipart/form-data" >
                            @csrf
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="type_house" id="inputID" class="form-control"
                                                   value="{{$products->type_house}}" required="required">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" id="inputID" class="form-control"
                                                   value="{{$products->name}}" required="required">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="area" id="inputID" class="form-control"
                                                   value="{{$products->area}}" required="required">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="status" class="form-control"
                                                   value="{{$products->status}}" required="required">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="price" class="form-control"
                                                   value="{{$products->price}}" required="required">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" class="form-control"
                                                   value="{{$products->title}}" required="required">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td><img style="height: 100px; width: 250px" src="{{asset('storage/'. $products->image)}}"></td>
                                </tr>
                                </tbody>
                            </table>
                            <table class="table table-hover">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <textarea name="content" rows="5" class="form-control"
                                                  value="{{$products->content}}"></textarea>
                                    </td>
                                </tr>
                                <tr>
